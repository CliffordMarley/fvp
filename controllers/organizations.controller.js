    ...
    Read = async (req, res)=>{
        try{
            ...
            if(sections && sections.length > 0){
                ...
                let constFilter = {DISTRICT:District.District_Name.toUpperCase().toString()}
                console.log("Constituency query: " ,constFilter)

                let Constituencies = await this.constituency.Read(constFilter)
